#!/usr/bin/env python3
"""
Celigo MCP Bridge — stdio ↔ n8n SSE proxy for Claude Desktop.

Bridges the n8n per-workflow SSE endpoint to Claude Desktop's stdio MCP transport.
Claude Desktop spawns this script; it connects to the n8n Celigo tools workflow
and proxies all MCP messages over SSE.

Usage (Claude Desktop config):
    "celigo-tools": {
        "command": "python3",
        "args": ["/path/to/celigo_mcp_bridge.py"]
    }
"""
...
MCP_PATH = os.environ.get("CELIGO_MCP_PATH", "celigo-tools")
