#!/usr/bin/env python3
"""
EDI Ops MCP Bridge — stdio ↔ n8n SSE proxy for Claude Desktop.

Bridges the n8n edi-ops workflow SSE endpoint to Claude Desktop's stdio MCP transport.
Claude Desktop spawns this script; it connects to the n8n EDI Ops workflow
and proxies all MCP messages over SSE.

Usage (Claude Desktop config):
    "edi-ops": {
        "command": "python3",
        "args": ["/path/to/edi_ops_mcp_bridge.py"]
    }
"""
...
MCP_PATH = os.environ.get("EDI_OPS_MCP_PATH", "edi-ops")
