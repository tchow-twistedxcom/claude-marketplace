...
| Short text (< 255 chars) | TEXT | Names, codes, IDs |
| Long text (< 4000 chars) | TEXTAREA | Descriptions, notes |
| Very long text | CLOBTEXT | Large text blocks |
